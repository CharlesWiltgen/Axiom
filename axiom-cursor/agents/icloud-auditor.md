---
name: icloud-auditor
description: "Use this agent when the user mentions iCloud sync issues, CloudKit errors, ubiquitous container problems, or asks to audit cloud sync."
model: inherit
readonly: true
is_background: true
---
...
assistant: [Delegate to the `icloud-auditor` subagent]
</example>
