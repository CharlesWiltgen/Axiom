---
name: iap-auditor
description: "Use this agent when the user mentions in-app purchase review, IAP audit, StoreKit issues, purchase bugs, transaction problems, or subscription management."
model: inherit
readonly: true
is_background: true
---
