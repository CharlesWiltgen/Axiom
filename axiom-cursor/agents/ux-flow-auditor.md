...
description: "Use this agent when the user mentions UX flow issues, dead-end views, dismiss traps, missing empty states, broken user journeys, or wants a UX audit of their iOS app."
model: inherit
readonly: true
is_background: true
---
