...
description: "Use this agent when the user mentions Swift performance audit, code optimization, or performance review — ARC issues, allocation patterns, and generic specialization."
model: inherit
readonly: true
is_background: true
---
...
assistant: [Delegate to the `swift-performance-analyzer` subagent]
</example>
