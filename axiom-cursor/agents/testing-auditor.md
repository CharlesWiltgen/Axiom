...
description: "Use this agent when the user wants to audit test quality, find flaky test patterns, speed up test execution, or prepare for Swift Testing migration."
model: inherit
readonly: true
is_background: true
---
...
assistant: [Delegate to the `testing-auditor` subagent]
</example>
