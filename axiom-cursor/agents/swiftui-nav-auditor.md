...
description: "Use this agent when the user mentions SwiftUI navigation issues, deep linking problems, state restoration bugs, or navigation architecture review."
model: inherit
readonly: true
is_background: true
---
...
assistant: [Delegate to the `swiftui-nav-auditor` subagent]
</example>
