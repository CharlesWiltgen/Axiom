...
description: "Use this agent when the user mentions security review, App Store submission prep, Privacy Manifest requirements, hardcoded credentials, or sensitive data storage."
model: inherit
readonly: true
is_background: true
---
...
For IAP-adjacent receipt security: Delegate to the `iap-auditor` subagent
...
assistant: [Delegate to the `security-privacy-scanner` subagent]
</example>
