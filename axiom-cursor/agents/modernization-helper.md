...
description: "Use this agent when the user wants to modernize iOS code to iOS 17/18 patterns, migrate from ObservableObject to @Observable, update @StateObject to @State, or adopt modern SwiftUI APIs."
model: inherit
readonly: true
is_background: true
---
