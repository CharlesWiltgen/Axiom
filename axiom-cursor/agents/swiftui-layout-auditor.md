...
description: "Use this agent when the user mentions SwiftUI layout review, adaptive layout issues, GeometryReader problems, or multi-device layout checking."
model: inherit
readonly: true
is_background: true
---
