...
description: "Run simulator test scenarios and visual verification with the simulator-tester subagent"
---


# Simulator Testing Agent

Delegate to the **simulator-tester** subagent for automated simulator testing with visual verification.
