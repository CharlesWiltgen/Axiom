...
| Automated resize-readiness scan (scene lifecycle, UIScreen.main, fixed-canvas, Mirroring input) | Delegate to the `resize-auditor` subagent or `/axiom-audit` resize |
