---
name: axiom-build
description: "Use when ANY iOS or macOS build fails, a crash log needs diagnosing, a test run crashes, Xcode misbehaves, or an environment issue blocks work before code is the suspect. Covers build failures, dependency conflicts, simulator diagnostics."
---
...
**Invoke**: Delegate to the `spm-conflict-resolver` subagent
...
**Invoke**: Delegate to the `security-privacy-scanner` subagent or `/axiom-audit` security
...
**Invoke**: Delegate to the `modernization-helper` subagent or `/axiom-audit` modernization
...
**Invoke**: Delegate to the `build-fixer` subagent or `/axiom-fix-build`
...
**Invoke**: Delegate to the `build-optimizer` subagent or `/axiom-optimize-build`
...
**Invoke**: Delegate to the `crash-analyzer` subagent or `/axiom-analyze-crash`
