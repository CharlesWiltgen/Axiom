...
**Concurrency audit** → Delegate to the `concurrency-auditor` subagent or `/axiom-audit` concurrency (5-phase semantic audit: maps isolation architecture, detects 8 anti-patterns, reasons about missing concurrency patterns, correlates compound risks, scores Swift 6.4 readiness)
