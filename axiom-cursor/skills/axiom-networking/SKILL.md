...
**Networking audit** → Delegate to the `networking-auditor` subagent or `/axiom-audit` networking (deprecated APIs, anti-patterns, and completeness gaps — transition handling, TLS coverage, connection cleanup, framework selection)
