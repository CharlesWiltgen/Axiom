...
> For silent push notification patterns (content-available payload, throttling limits, APNs setup), see references/push-notifications.md.
...
**Skills**: references/background-processing-ref.md, references/background-processing-diag.md, axiom-energy, references/push-notifications.md
