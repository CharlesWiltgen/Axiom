...
**Related skills**: `references/background-processing.md` (patterns, checklists), `references/background-processing-ref.md` (API reference)
...
**Skills**: references/background-processing.md, references/background-processing-ref.md
