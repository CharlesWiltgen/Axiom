...
Complete API reference for iOS timer mechanisms. For decision trees and crash prevention, see `references/timer-patterns.md`.
...
For a safe wrapper that prevents all crash patterns, see `references/timer-patterns.md` Part 4: SafeDispatchTimer.
...
- `references/timer-patterns.md` — Decision trees, crash patterns, SafeDispatchTimer wrapper
...
**Skills**: references/timer-patterns.md, axiom-energy-ref, axiom-memory-debugging
