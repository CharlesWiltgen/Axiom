...
- You need detailed API reference (use app-intents-ref, references/app-shortcuts-ref.md, references/core-spotlight-ref.md)
...
**Skills**: references/app-intents-ref.md, references/app-shortcuts-ref.md, references/core-spotlight-ref.md
