...
- Pure App Intents implementation (see `references/app-intents-ref.md`)
...
- `references/extensions-widgets-ref.md` — Comprehensive API reference
- `references/app-intents-ref.md` — App Intents for interactive widgets
...
> For comprehensive push notification setup (APNs auth, payload format, token management, service extensions), see references/push-notifications.md and references/push-notifications-ref.md. This skill covers the ActivityKit UI and state management side.
...
**Skills**: references/extensions-widgets-ref.md, references/push-notifications.md, references/push-notifications-ref.md, references/background-processing.md
