...
**Related skills**: `references/background-processing.md` (decision trees, patterns), `references/background-processing-diag.md` (troubleshooting)
...
**Skills**: references/background-processing.md, references/background-processing-diag.md
