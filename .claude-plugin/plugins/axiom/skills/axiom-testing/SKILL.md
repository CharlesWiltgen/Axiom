...
|----------------|-----------|
| Writing unit tests, Swift Testing (@Test, #expect) | See `references/swift-testing.md` |
| Making tests run without simulator | See `references/swift-testing.md` |
| Parameterized tests, tags, traits | See `references/swift-testing.md` |
| Migrating from XCTest to Swift Testing | See `references/swift-testing.md` |
| Testing async/await functions | See `references/testing-async.md` |
| confirmation for callbacks | See `references/testing-async.md` |
| @MainActor tests, parallel execution | See `references/testing-async.md` |
| Writing UI tests, XCUITest | See `references/ui-testing.md` |
| Condition-based waiting patterns | See `references/ui-testing.md` |
| Recording UI Automation (Xcode 26) | See `references/ui-testing.md` |
| Network conditioning, multi-factor testing | See `references/ui-testing.md` |
| XCUIElement queries, waiting strategies | See `references/xctest-automation.md` |
| Accessibility identifiers, test plans | See `references/xctest-automation.md` |
| CI/CD test execution | See `references/xctest-automation.md` |
| Record/Replay/Review workflow (Xcode 26) | See `references/ui-recording.md` |
| Test plan multi-configuration replay | See `references/ui-recording.md` |
| Enhancing recorded tests for stability | See `references/ui-recording.md` |
...
digraph testing {
    ...
    start -> what;
    what -> "references/swift-testing.md" [label="unit tests,\nSwift Testing,\nfast tests"];
    what -> "references/testing-async.md" [label="testing async code,\ncallbacks,\nconfirmation"];
    what -> "references/ui-testing.md" [label="UI tests,\nflaky tests,\nrecording"];
    what -> "references/xctest-automation.md" [label="XCUITest patterns,\nelement queries"];
    what -> "references/ui-recording.md" [label="Xcode 26\nRecord/Replay/Review"];
}
```

1. Writing unit tests / Swift Testing? → `references/swift-testing.md`
2. Testing async/await code? → `references/testing-async.md`
3. Writing UI tests / XCUITest / flaky tests? → `references/ui-testing.md`
...
**Swift Testing** (`references/swift-testing.md`):
...
**Async Testing** (`references/testing-async.md`):
...
**UI Testing** (`references/ui-testing.md`):
...
**XCUITest Automation** (`references/xctest-automation.md`):
...
**UI Recording** (`references/ui-recording.md`):
...
| Thought | Reality |
|---------|---------|
| "Simple test question, I don't need the skill" | Proper patterns prevent test debt. `references/swift-testing.md` has copy-paste solutions. |
| "I know XCTest well enough" | Swift Testing is significantly better for unit tests. Migration guide included. |
| "Tests are slow but it's fine" | Fast tests enable TDD. `references/swift-testing.md` shows how to run without simulator. |
| "I'll fix the flaky test with a sleep()" | sleep() makes tests slower AND flakier. `references/ui-testing.md` has condition-based waiting. |
| "I'll add tests later" | Tests written after implementation miss edge cases. |

## Example Invocations

User: "How do I write a unit test in Swift?"
→ Read: `references/swift-testing.md`

User: "My UI tests are flaky in CI"
→ Check codebase: XCUIApplication/XCUIElement? → `references/ui-testing.md`
→ Check codebase: @Test/#expect? → test-failure-analyzer (Agent)

User: "How do I test async code without flakiness?"
→ Read: `references/testing-async.md`

User: "What's the Swift Testing equivalent of XCTestExpectation?"
→ Read: `references/testing-async.md`

User: "I want my tests to run faster"
→ Read: `references/swift-testing.md` (Strategy 1: Package extraction)

User: "Should I use Swift Testing or XCTest?"
→ Read: `references/swift-testing.md` (Migration section) + this decision tree

User: "How do I record UI automation in Xcode 26?"
→ Read: `references/ui-recording.md`
