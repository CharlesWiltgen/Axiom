...
For CarPlay-specific integration patterns, see `references/now-playing-carplay.md`.
...
For MusicKit-specific integration patterns and hybrid app examples, see `references/now-playing-musickit.md`.
...
**Skills**: references/avfoundation-ref.md, references/now-playing-carplay.md, references/now-playing-musickit.md
