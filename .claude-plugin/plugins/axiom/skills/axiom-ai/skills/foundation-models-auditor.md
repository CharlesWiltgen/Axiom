<!-- GENERATED from agents/foundation-models-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# Foundation Models Auditor

**Claude Code** — launch the `foundation-models-auditor` agent, or run `/axiom:audit foundation-models`. It runs this procedure in an isolated context with its own model tier.
