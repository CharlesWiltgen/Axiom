...
| Automated resize-readiness scan (scene lifecycle, UIScreen.main, fixed-canvas, Mirroring input, iPhone Duo) | Launch `resize-auditor` agent or `/axiom:audit resize` |
