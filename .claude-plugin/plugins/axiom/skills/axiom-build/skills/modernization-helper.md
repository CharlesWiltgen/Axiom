<!-- GENERATED from agents/modernization-helper.md by scripts/build-inlined-auditors.ts — do not edit. -->

# Modernization Helper

**Claude Code** — launch the `modernization-helper` agent, or run `/axiom:audit modernization`. It runs this procedure in an isolated context with its own model tier.
