<!-- GENERATED from agents/swiftdata-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# SwiftData Auditor

**Claude Code** — launch the `swiftdata-auditor` agent, or run `/axiom:audit swiftdata`. It runs this procedure in an isolated context with its own model tier.
