<!-- GENERATED from agents/storage-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# Storage Auditor

**Claude Code** — launch the `storage-auditor` agent, or run `/axiom:audit storage`. It runs this procedure in an isolated context with its own model tier.
