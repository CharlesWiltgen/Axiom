<!-- GENERATED from agents/core-data-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# Core Data Auditor

**Claude Code** — launch the `core-data-auditor` agent, or run `/axiom:audit core-data`. It runs this procedure in an isolated context with its own model tier.
