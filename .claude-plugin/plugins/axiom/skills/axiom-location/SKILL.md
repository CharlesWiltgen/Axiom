...
|----------------|-----------|
| Authorization strategy (When In Use vs Always) | See `references/core-location.md` |
| Monitoring approach (continuous, significant-change, CLMonitor) | See `references/core-location.md` |
| Accuracy selection, background location | See `references/core-location.md` |
| CLLocationUpdate, CLMonitor, CLServiceSession APIs | See `references/core-location-ref.md` |
| Authorization API patterns, geofencing API | See `references/core-location-ref.md` |
| Location updates never arrive | See `references/core-location-diag.md` |
| Background location stops working | See `references/core-location-diag.md` |
| Authorization always denied, geofence failures | See `references/core-location-diag.md` |
| SwiftUI Map, annotations, markers, clustering | See `references/mapkit.md` |
| MKMapView vs SwiftUI Map decision | See `references/mapkit.md` |
| Search, directions, routing | See `references/mapkit.md` |
| MapKit API: Marker, Annotation, MKLocalSearch, MKDirections | See `references/mapkit-ref.md` |
| Look Around, MKMapSnapshotter, MKMapItem | See `references/mapkit-ref.md` |
| Annotations not appearing, region jumping | See `references/mapkit-diag.md` |
| Clustering not working, search failures | See `references/mapkit-diag.md` |
| Overlay rendering, user location not showing | See `references/mapkit-diag.md` |
...
digraph location {
    ...
    cl_type -> "references/core-location.md" [label="authorization, monitoring\nstrategy, accuracy,\nbackground location"];
    cl_type -> "references/core-location-ref.md" [label="API syntax\n(CLLocationUpdate,\nCLMonitor, CLServiceSession)"];
    cl_type -> "references/core-location-diag.md" [label="something broken\n(no updates, denied,\ngeofence not firing)"];

    mk_type -> "references/mapkit.md" [label="patterns, decisions\n(SwiftUI Map vs MKMapView,\nannotations, search)"];
    mk_type -> "references/mapkit-ref.md" [label="API syntax\n(Marker, Annotation,\nMKLocalSearch, MKDirections)"];
    mk_type -> "references/mapkit-diag.md" [label="something broken\n(annotations missing,\nregion jumping, clustering)"];
}
```

1. Authorization strategy, monitoring approach, accuracy? → `references/core-location.md`
1a. Need specific API syntax (CLLocationUpdate, CLMonitor, CLServiceSession)? → `references/core-location-ref.md`
1b. Location not working? → `references/core-location-diag.md`
2. Adding a map, annotations, search, directions? → `references/mapkit.md`
2a. Need specific MapKit API syntax (Marker, MKLocalSearch, MKDirections)? → `references/mapkit-ref.md`
2b. Map display broken? → `references/mapkit-diag.md`
3. Location draining battery? → See axiom-performance (references/energy.md)
...
1. **Try location FIRST** — Excessive accuracy or continuous updates are the #1 cause. `references/core-location.md` covers accuracy selection and monitoring strategy.
...
- Authorization dialogs, Info.plist keys → **use location** (`references/core-location-diag.md`)
- Simulator GPS simulation, `simctl location` → **use ios-build**

## Critical Patterns

**Core Location** (`references/core-location.md`):
...
**Core Location API** (`references/core-location-ref.md`):
...
**Core Location Diagnostics** (`references/core-location-diag.md`):
...
**MapKit API** (`references/mapkit-ref.md`):
...
**MapKit Diagnostics** (`references/mapkit-diag.md`):
...
| Thought | Reality |
|---------|---------|
| "Just request Always authorization upfront" | 30-60% denial rate. Request When In Use first, escalate later. `references/core-location.md` covers the strategy. |
...
| "I'll use MKMapView, it's more flexible" | SwiftUI Map covers most use cases since iOS 17. MKMapView means UIViewRepresentable boilerplate. `references/mapkit.md` has the decision tree. |
...
→ Read: `references/core-location.md`

User: "What's the CLLocationUpdate API?"
→ Read: `references/core-location-ref.md`

User: "My location updates never arrive"
→ Read: `references/core-location-diag.md`

User: "How do I add a map with pins?"
→ Read: `references/mapkit.md`

User: "What's the SwiftUI Map API?"
→ Read: `references/mapkit-ref.md`

User: "My annotations aren't showing on the map"
→ Read: `references/mapkit-diag.md`

User: "How do I implement geofencing?"
→ Read: `references/core-location.md` then `references/core-location-ref.md`

User: "Location is draining battery"
→ Read: `references/core-location.md`, then See axiom-performance (references/energy.md)

User: "How do I add search to my map?"
→ Read: `references/mapkit.md` then `references/mapkit-ref.md`
