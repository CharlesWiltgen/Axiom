<!-- GENERATED from agents/ux-flow-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# UX Flow Auditor

**Claude Code** — launch the `ux-flow-auditor` agent, or run `/axiom:audit ux-flow`. It runs this procedure in an isolated context with its own model tier.
