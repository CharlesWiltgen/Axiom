<!-- GENERATED from agents/networking-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# Networking Auditor

**Claude Code** — launch the `networking-auditor` agent, or run `/axiom:audit networking`. It runs this procedure in an isolated context with its own model tier.
