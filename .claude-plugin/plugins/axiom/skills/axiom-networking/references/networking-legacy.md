...
These patterns use NWConnection with completion handlers for apps supporting iOS 12-25. If your app targets iOS 26+, use NetworkConnection with async/await instead (see `references/network-framework-ref.md`).
...
- See Pattern 1d in `references/network-framework-ref.md`

## Resources

**Skills**: See `references/networking.md`, `references/network-framework-ref.md`, `references/networking-migration.md`
