<!-- GENERATED from agents/spritekit-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# SpriteKit Auditor

**Claude Code** — launch the `spritekit-auditor` agent, or run `/axiom:audit spritekit`. It runs this procedure in an isolated context with its own model tier.
