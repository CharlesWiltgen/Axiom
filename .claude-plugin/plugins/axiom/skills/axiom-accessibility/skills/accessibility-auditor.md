<!-- GENERATED from agents/accessibility-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# Accessibility Auditor

**Claude Code** — launch the `accessibility-auditor` agent, or run `/axiom:audit accessibility`. It runs this procedure in an isolated context with its own model tier.
