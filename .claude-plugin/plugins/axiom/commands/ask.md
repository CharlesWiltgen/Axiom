...
- **axiom-xcode-mcp** — Use when connecting to Xcode via MCP, using xcrun mcpbridge or the headless mcp-server, launching agents from Xcode, or working with ANY Xcode MCP tool (XcodeRead, BuildProject, RunSomeTests, RenderPreview).
