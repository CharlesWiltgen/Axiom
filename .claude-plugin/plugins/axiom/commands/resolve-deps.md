---
name: resolve-deps
description: Diagnose and resolve Swift Package Manager dependency conflicts (launches spm-conflict-resolver agent)
disable-model-invocation: true
---

# Resolve Dependency Conflicts

Launches the **spm-conflict-resolver** agent to diagnose Swift Package Manager resolution failures, version conflicts, and the link errors they cause.
