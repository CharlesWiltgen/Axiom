...
#### Related Skills
- See `references/networking-diag.md` for systematic troubleshooting of connection failures, timeouts, and performance issues
- See `references/network-framework-ref.md` for comprehensive API reference with all WWDC examples
...
For apps supporting iOS 12-25 that can't use async/await yet, see `references/networking-legacy.md`:
...
For detailed migration guides from legacy networking APIs, see `references/networking-migration.md`:
...
**Skills**: See `references/networking-diag.md`, `references/network-framework-ref.md`
