...
#### Related Skills
- See `references/networking.md` for anti-patterns, common patterns, pressure scenarios
- See `references/networking-diag.md` for systematic troubleshooting of connection failures
...
**Skills**: See `references/networking.md`, `references/networking-diag.md`
