...
**Skills**: skills/contacts.md (contact permission handling), skills/eventkit.md (calendar permission handling), axiom-shipping (skills/app-store-ref.md), `axiom-scan-security-privacy` (ATT and manifest detection)
