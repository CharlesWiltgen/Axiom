...
Complements `references/swift-concurrency.md` (which covers *when* and *why* to use concurrency — progressive journey, decision trees, @concurrent, isolated conformances).

**Related references**: `references/swift-concurrency.md` (progressive journey, decision trees), `references/synchronization.md` (Mutex, locks), `references/assume-isolated.md` (assumeIsolated patterns)
...
See `references/assume-isolated.md` for comprehensive patterns.
...
**Skills**: See `references/swift-concurrency.md`, `references/assume-isolated.md`, `references/synchronization.md`, `references/concurrency-profiling.md`
