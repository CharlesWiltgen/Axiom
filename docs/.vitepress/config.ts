...
export default withMermaid(defineConfig({
  ...
  themeConfig: {
      ...
      '/skills/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'SwiftUI Presentations', link: '/skills/ui-design/swiftui-presentations' },
            ...
            { text: 'UIKit Adaptive Layout', link: '/skills/ui-design/uikit-adaptive-layout' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'DockKit (Motorized Stands)', link: '/skills/integration/dockkit' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'iOS Apps on Mac', link: '/skills/macos/ios-apps-on-mac' },
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 Charles Wiltgen • v27.0.0-beta.31'
    }
  }
}))
