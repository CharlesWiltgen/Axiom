...
- **<!--ax:discipline-->166<!--/ax--> discipline skills** – Mandatory workflows (18 TDD-tested using ["red/green/refactor" methodology](https://en.wikipedia.org/wiki/Test-driven_development))
...
#### Total: <!--ax:skills-->275<!--/ax--> skills + <!--ax:commands-->17<!--/ax--> commands + <!--ax:agents-->42<!--/ax--> agents
