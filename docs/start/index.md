...
- **<!--ax:discipline-->156<!--/ax--> discipline skills** – Mandatory workflows (18 TDD-tested using ["red/green/refactor" methodology](https://en.wikipedia.org/wiki/Test-driven_development))
- **<!--ax:reference-->80<!--/ax--> reference skills** – Comprehensive API guides with code examples
...
#### Total: <!--ax:skills-->261<!--/ax--> skills + <!--ax:commands-->15<!--/ax--> commands + <!--ax:agents-->41<!--/ax--> agents
