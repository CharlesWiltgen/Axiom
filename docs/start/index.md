...
Welcome to Axiom — battle-tested AI skills, agents, and tools for modern xOS (iOS, iPadOS, macOS, tvOS, watchOS) development — Swift 6, SwiftUI, Liquid Glass, Apple Intelligence, and more.

## What is Axiom?

Axiom provides comprehensive Apple platform development workflows:

- **<!--ax:discipline-->165<!--/ax--> discipline skills** – Mandatory workflows (18 TDD-tested using ["red/green/refactor" methodology](https://en.wikipedia.org/wiki/Test-driven_development))
- **<!--ax:reference-->82<!--/ax--> reference skills** – Comprehensive API guides with code examples
- **<!--ax:diagnostic-->27<!--/ax--> diagnostic skills** – Systematic troubleshooting with decision trees
- **<!--ax:commands-->17<!--/ax--> commands** – Quick automated scans for common issues
- **<!--ax:agents-->42<!--/ax--> agents** – Autonomous code scanning and natural language automation

#### Total: <!--ax:skills-->274<!--/ax--> skills + <!--ax:commands-->17<!--/ax--> commands + <!--ax:agents-->42<!--/ax--> agents
