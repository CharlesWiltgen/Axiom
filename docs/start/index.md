...
- **<!--ax:discipline-->155<!--/ax--> discipline skills** – Mandatory workflows (18 TDD-tested using ["red/green/refactor" methodology](https://en.wikipedia.org/wiki/Test-driven_development))
...
#### Total: <!--ax:skills-->259<!--/ax--> skills + <!--ax:commands-->15<!--/ax--> commands + <!--ax:agents-->41<!--/ax--> agents
