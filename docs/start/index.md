...
- **<!--ax:agents-->40<!--/ax--> agents** – Autonomous code scanning and natural language automation

#### Total: <!--ax:skills-->254<!--/ax--> skills + <!--ax:commands-->15<!--/ax--> commands + <!--ax:agents-->40<!--/ax--> agents
