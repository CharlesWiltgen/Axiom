...
This installs all <!--ax:skills-->269<!--/ax--> skills globally using [npx skills](https://skills.sh/). The `-g` flag makes skills available across all projects.
...
- **[Claude Code](/start/install)** – Full Axiom experience with <!--ax:agents-->42<!--/ax--> autonomous agents and <!--ax:commands-->15<!--/ax--> commands
