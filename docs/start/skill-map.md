...
Visual overview of Axiom's two-layer routing architecture. 23 routers organize <!--ax:skills-->273<!--/ax--> skills, <!--ax:agents-->42<!--/ax--> agents, and <!--ax:commands-->17<!--/ax--> commands into discoverable domains.
