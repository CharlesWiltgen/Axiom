...
Visual overview of Axiom's two-layer routing architecture. 23 routers organize <!--ax:skills-->262<!--/ax--> skills, <!--ax:agents-->41<!--/ax--> agents, and <!--ax:commands-->15<!--/ax--> commands into discoverable domains.
