...
- **Voice control template (`CPVoiceControlTemplate`)** — voice control UI for navigation apps and (iOS 26.4+) driving task and voice-based conversational apps
