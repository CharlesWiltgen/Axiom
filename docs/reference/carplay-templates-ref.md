...
- **Template × category availability matrix** – for each of the 12 templates, which of the 11 CarPlay app categories may use it (with iOS version footnotes for iOS 17+ and iOS 26.4+ additions)
