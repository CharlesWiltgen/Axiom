...
This page documents the `axiom-integration` reference skill—complete API coverage Claude uses when you need specific privacy manifest structures, permission patterns, or ATT implementation details.
