...
const ROUTER_TO_CATEGORY = {
  ...
  'axiom-concurrency': 'docs/skills/concurrency/index.md',
  'axiom-ios-data': 'docs/skills/persistence/index.md',
  'axiom-integration': 'docs/skills/integration/index.md',
  'axiom-media': 'docs/skills/integration/index.md',
  'axiom-testing': 'docs/skills/testing/index.md',
  'axiom-games': 'docs/skills/games/index.md',
